...
*/
createMenuItem('macandcheese',5,'lunch');
createMenuItem('fries',3,"side");
createMenuItem('mtDew',2,"soda");
console.log(createMenuItem("macandcheese",5,"lunch"));
console.log(createMenuItem("fries",3,"side"));
console.log(createMenuItem("mtDew",2,"soda"));
...
reviews.push ({
  name: "Anakin",
  rating: 3,
  feedback: "The Jedi poisoned my food, but the restaurant was clean at least!"
});
console.log(reviews);
