...
function createMenuItem(price, name, category){
  return {name: name, 
    price: price, 
    category: category,}
}
...
console.log(createMenuItem('steak', 5, dinner));
...
*/
reviews.push({name: 'Dave', rating: 1, feedback: "The food is awful, I got food poisoning from this!"!})
